            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between">
                        <h6 class="text-white text-capitalize ps-3">Thêm chuyên mục</h6>
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        <form action="/admin/category/add" method="post" class="mx-4">
                            @csrf
                            <div class="my-2">
                                <label for="categoryName" class="form-label text-dark">Tên loại<span class="text-danger"> *</span></label>
                                <input type="text" name="categoryName" id="categoryName" class="form-control" value="{{old('categoryName')}}">
                                @error('categoryName')
                            ...
                            <div class="my-2">
                                ...
                                <textarea type="description" class="form-control" name="description" id="description" rows="5">{{old('description')}}</textarea>
                            </div>
