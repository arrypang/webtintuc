            ...
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <ul class="nav justify-content-end mx-5 pt-0 pb-2">
                        <li class="nav-item">
                            <a class="nav-link active text-sm text-dark" aria-current="page" href="#">Bản nháp</a>
                        </li>
                    </ul>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <p class=" text-xs font-weight-bold mb-0">{{$article->status}}</p>
                                    </td>
                                    <td class="align-middle text-center">
                                        <p class=" text-xs font-weight-bold mb-0">Phê duyệt</p>
                                    </td>
                                    <td class="align-middle text-center">
